...
cyclistic_datetime$start_time <- as_hms((cyclistic_datetime$started_at)) #create new column for time
cyclistic_datetime$hour <- hour(cyclistic_datetime$start_time) #create new column for hour
...
cyclistic_tableau <- cyclistic_datetime
...
fwrite(cyclistic_tableau,"cyclistic_tableau_data.csv")
